...
public class D04P03 {
    ...
    public static class CatheyBankException extends Exception {
        ...
        // Adding the serialVersionUID field to resolve the serializable class error
    ...
    public static class Validator {
        public boolean validate(D04P03 applicant) throws CatheyBankException {
            ...
            } else if (!validatePost(applicant.getPostApplied())) {
                throw new CatheyBankException("Invalid Post");
            } else if (!validateAge(applicant.getApplicantAge())) {
